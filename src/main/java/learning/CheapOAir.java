...
public class CheapOAir {
	...
	public static void main(String[] args) throws InterruptedException {
		...
		Thread.sleep(6000);	
		WebElement oneWayRadio = driver.findElement(By.id("onewayTrip"));
		driver.executeScript("arguments[0].click();", oneWayRadio);
		
		
		Thread.sleep(2000);
		driver.findElement(By.id("from0")).sendKeys(Keys.chord(Keys.CONTROL,"a",Keys.DELETE));
		Thread.sleep(1000);
		...
		WebElement DepartureDate = textBox=driver.findElement(By.id("cal0"));
		DepartureDate.click();
